...
# Switches
set_property PACKAGE_PIN V17 [get_ports {wanted_ub[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {wanted_ub[0]}]
set_property PACKAGE_PIN V16 [get_ports {wanted_ub[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {wanted_ub[1]}]
set_property PACKAGE_PIN W16 [get_ports {wanted_ub[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {wanted_ub[2]}]
...
# Buttons
 set_property PACKAGE_PIN U18 [get_ports mode_sw]
...
## Pmod Header JA
## Sch name = JA1
 set_property PACKAGE_PIN J1 [get_ports {ir_sensor[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ir_sensor[0]}]
## Sch name = JA2
 set_property PACKAGE_PIN L2 [get_ports {ir_sensor[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ir_sensor[1]}]
## Sch name = JA3
 set_property PACKAGE_PIN J2 [get_ports {ir_sensor[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ir_sensor[2]}]
## Sch name = JA4
 set_property PACKAGE_PIN G2 [get_ports {ir_sensor[3]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ir_sensor[3]}]
## Sch name = JA7
 set_property PACKAGE_PIN H1 [get_ports {relay}]
    set_property IOSTANDARD LVCMOS33 [get_ports {relay}]
## Sch name = JA8
 set_property PACKAGE_PIN K2 [get_ports {PWM_0}]
...
## Sch name = JB3
 set_property PACKAGE_PIN B15 [get_ports {sonic_trig[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sonic_trig[1]}]
## Sch name = JB4
 set_property PACKAGE_PIN B16 [get_ports {sonic_echo[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sonic_echo[1]}]
## Sch name = JB7
 set_property PACKAGE_PIN A15 [get_ports {motor_cw[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {motor_cw[0]}]
## Sch name = JB8
 set_property PACKAGE_PIN A17 [get_ports {motor_ccw[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {motor_ccw[0]}]
## Sch name = JB9
 set_property PACKAGE_PIN C15 [get_ports {motor_cw[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {motor_cw[1]}]
## Sch name = JB10
 set_property PACKAGE_PIN C16 [get_ports {motor_ccw[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {motor_ccw[1]}]
...
## Sch name = JC3
 set_property PACKAGE_PIN N17 [get_ports {ble_tx}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ble_tx}]
## Sch name = JC4
 set_property PACKAGE_PIN P18 [get_ports {ble_rx}]
