...
set_property PACKAGE_PIN P1 [get_ports {led_err}]
...
## Pmod Header JA
## Sch name = JA1
# set_property PACKAGE_PIN J1 [get_ports {ble_rx}]
...
## Sch name = JA4
 set_property PACKAGE_PIN G2 [get_ports {ble_rx}]
    set_property IOSTANDARD LVCMOS33 [get_ports {ble_rx}]
...
## Sch name = JB3
# set_property PACKAGE_PIN B15 [get_ports {sw0}]
